                        ...
                        <div class="row row-20 gutters-20">
                            <div class="col-12">
                                <div class="form-wrap wow fadeIn">
                                    ...
                                    <textarea class="form-input textarea-lg" id="comment" placeholder="Comentario" name="comment"></textarea>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="user_id" value="{{auth()->user()->id}}">
                        <div class="group-custom-1 group-middle oh-desktop justify-content-center">
                            <button class="button button-lg button-primary button-winona wow fadeInRight" type="submit">Agregar Comentario</button>
                        </div>
                    </form>
                </div>
            </div>
